...
| 3 | [Testing an Agent That Must Not Invent Commitments](03-agents-for-humans-testing-an-agent-that-must-not-invent-commitments.md) | Source-grounded extraction, negative tests, and an honest baseline | 50-case gold set and 131 local tests |
...
- [ ] Keep the no-pilot, no-user-quote, no-Bedrock-score, and no-cloud-deployment limitations that
      apply to that post.
